...
@DriftDatabase(tables: [RecordMessage,GlobalImageCache,CacheViewMessage,FriendsNote],daos: [RecordMessageDao,GlobalImageCacheDao,CacheViewMessageDao,FriendsNoteDao])
